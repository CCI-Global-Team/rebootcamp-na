...
import { getChurchCenterFormUrl, hopeCampaign } from "@/lib/hope/campaign";
...
export const metadata: Metadata = {
  title: "Hope | Reboot Camp North America",
  description:
    ...
    <div className="font-inter min-h-screen bg-[#080b1a] text-white">
      ...
      <main>
        ...
        <section
          ...
          id="hope-form"
          aria-labelledby="hope-form-title"
        >
      ...
      <footer className="border-t border-white/10 bg-[#040610] px-6 py-10 text-center text-white/65">
        <strong className="font-oswald text-xl font-bold text-white uppercase">
          {hopeCampaign.footerTitle}
        </strong>
        <p className="mt-3 mb-4">{hopeCampaign.footerBody}</p>
